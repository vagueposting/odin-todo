import { assembleParts, IconButton } from './utils.js';
    ...
    const sections = new Map([
        ...
        ['controls', () => {
            ...
            controlConfigs.forEach(config => {
                const { name, target, path } = config
                const iconBtn = new IconButton(name, target, path);

                if (name === 'refresh') {
                    iconBtn.onClick(() => refreshList());
                }

                shell.appendChild(iconBtn.render());
            })
